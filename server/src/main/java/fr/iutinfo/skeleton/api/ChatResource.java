...
public class ChatResource {
    ...
    public void creation_table(){
    	dao.insert(new Chat(1, "Dylan", "Bonjour, je test le chat!", new Date()));
    	dao.insert(new Chat(2, "Douglas", "Il semble fonctionner.", new Date()));
    	dao.insert(new Chat(3, "Caroline", "Coucou tout le monde!", new Date()));
    }
